...
export class ProfileComponent implements OnInit {
  ...
  followRequest?: FollowRequestModel = {receiverId: 0, senderId: 0};
  followStatus?: FollowRequestResponseModel;
  saveFollow?: FollowRequestModel = {receiverId: 0, senderId: 0};
  updateFollowRequest?: FollowRequestModel = {receiverId: 0, senderId: 0}
  ...
  cancelFollowRequest(loggedInUserId: number, visitedUserId: number) {
    this.followRequestService.cancelFollowRequest(loggedInUserId, visitedUserId).subscribe();
  }
  ...
  cancelFollow(loggedInUserId: number, visitedUserId: number) {
    ...
    this.followService.cancelFollow(loggedInUserId,visitedUserId).subscribe();
  }
